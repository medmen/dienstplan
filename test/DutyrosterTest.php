...
class DutyrosterTest extends TestCase
{
  #  use ProphecyTrait;
    ...
    private DutyrosterMock $dutyroster_mock;
    ...
    protected function setUp(): void
    {
        ...
        $this->dutyroster_mock = new DutyrosterMock($this->fixed_datetime);
    ...
    {
        $this->assertTrue($this->dutyroster_mock->has_noduty_wish('anton', 4));
    }

    public function test_candidates_have_duty_wish(): void
    {
        $this->assertContains('anton', $this->dutyroster_mock->candidates_have_duty_wish(1));
        $this->assertContains('berta', $this->dutyroster_mock->candidates_have_duty_wish(8));
    }
    ...
    public function test_had_duty_previous_day(): void
    {
        ...
        $this->assertTrue($this->dutyroster_mock->had_duty_previous_day('berta', 3));
        $this->assertFalse($this->dutyroster_mock->had_duty_previous_day('anton', 3));
        $this->assertFalse($this->dutyroster_mock->had_duty_previous_day('conny', 3));
    }
}
